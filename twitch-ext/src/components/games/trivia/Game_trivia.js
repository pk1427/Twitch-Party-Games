...
import "./Game_trivia.css"; // Ensure the CSS path is correct
import Quiz from "./Quiz"; // Update the import to reflect the new structure
// import Footer from "./Footer/Footer";

function Game_trivia() {
    ...
    return (
        <div className="GameTrivia_App">
            <div className="GameTrivia_blobs">
                <svg
                    className="GameTrivia_blob2"
            ...
            {!gameStart && (
                <main className="GameTrivia_welcomePage">
                    <h1 className="GameTrivia_heading">Quizzical</h1>

                    <h3 className="GameTrivia_subHeading">
                        Trivia Game that tests your knowledge of most
                        unimportant topics 🤓
                    </h3>

                    <button className="GameTrivia_startButton" onClick={startQuiz}>
                        Start Quiz
                    </button>
                </main>
            )}
